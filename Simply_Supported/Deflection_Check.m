...
function [LD_maximum,LD_Provided,Check_2] = Deflection_Check (r,AreaP_Tension_2,AreaP_Compression,Span,XDim,de_beam,Fy,AreaR_Tension,Modification_Factor_2)
%% Deflection check
fprintf('\n')
...
for i=1:r
   ...
   PtP_Compression=(AreaP_Compression(i)/(XDim*de_beam))*100;
