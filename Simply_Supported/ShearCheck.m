...
## -*- texinfo -*- 
## @deftypefn {} {@var{retval} =} ShearCheck (@var{input1}, @var{input2})
##
## @seealso{}
## @end deftypefn
...
function [Tc,Nominal_Shear_Stress,Design_Shear_Stress,Pt_P,Sr_R,Sv_P] = ShearCheck (AreaP_Tension_2, XDim,de_beam,r,Vu,Design_Shear_Strength,Design_Shear_Strength_1,Design_Shear_Strength_2,Fck,Fy,Asv)
...
for i=1:r
  %%Pt_Provided in %
  Pt_Provided=(100*AreaP_Tension_2'(i))/(XDim*de_beam);
   Tv=(Vu(i)*1000)/(XDim*de_beam);
